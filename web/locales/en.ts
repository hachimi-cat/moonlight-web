export const en = {
    ...
    stream: {
        ...
        streamEnded: "The game has ended. You can close this tab.",
        connectionFailed: "Connection failed",
        connectionLost: "Connection to the machine was lost. Close this tab and reopen the game to reconnect.",
    ...
    settings: {
        ...
        multiControllerMode: "Multi-controller mode",
        multiControllerAuto: "Auto (one controller per gamepad and browser stream)",
        multiControllerSingle: "Single (force player 1 connected)",
