...
export const ptBR: Translations = {
    ...
    stream: {
        ...
        streamEnded: "O jogo terminou. Você pode fechar esta aba.",
        connectionFailed: "Falha na conexão",
        connectionLost: "A conexão com a máquina foi perdida. Feche esta aba e abra o jogo novamente para reconectar.",
    ...
    settings: {
        ...
        multiControllerMode: "Modo multicontrole",
        multiControllerAuto: "Automático (um controle por gamepad e transmissão)",
        multiControllerSingle: "Único (manter jogador 1 conectado)",
