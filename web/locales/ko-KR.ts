...
export const koKR: Translations = {
    ...
    stream: {
        ...
        streamEnded: "게임이 종료되었습니다. 이 탭을 닫아도 됩니다.",
        connectionFailed: "연결 실패",
        connectionLost: "머신과의 연결이 끊어졌습니다. 이 탭을 닫고 게임을 다시 열어 재연결하세요.",
    ...
    settings: {
        ...
        multiControllerMode: "멀티 컨트롤러 모드",
        multiControllerAuto: "자동 (게임패드 및 브라우저 스트림별 컨트롤러)",
        multiControllerSingle: "단일 (플레이어 1 항상 연결)",
        invertAB: "A/B 버튼 반전",
        invertXY: "X/Y 버튼 반전",
