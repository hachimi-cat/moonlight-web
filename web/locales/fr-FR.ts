...
export const frFr: Translations = {
    ...
    stream: {
        ...
        streamEnded: "La partie est terminée. Vous pouvez fermer cet onglet.",
        connectionFailed: "Échec de la connexion",
        connectionLost: "La connexion à la machine a été perdue. Fermez cet onglet et relancez le jeu pour vous reconnecter.",
    ...
    settings: {
        ...
        multiControllerMode: "Mode multi-contrôleur",
        multiControllerAuto: "Auto (une manette par périphérique et flux navigateur)",
        multiControllerSingle: "Unique (forcer le joueur 1 connecté)",
