...
export const zhCN: Translations = {
    ...
    stream: {
        ...
        streamEnded: "游戏已结束。您可以关闭此标签页。",
        connectionFailed: "连接失败",
        connectionLost: "与机器的连接已断开。请关闭此标签页并重新打开游戏以重新连接。",
    ...
    settings: {
        ...
        multiControllerMode: "多手柄模式",
        multiControllerAuto: "自动（每个手柄和浏览器串流独立）",
        multiControllerSingle: "单手柄（始终连接玩家 1）",
        invertAB: "交换 A 和 B",
        invertXY: "交换 X 和 Y",
